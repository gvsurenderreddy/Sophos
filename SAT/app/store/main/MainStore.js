Ext.define('SAT.store.main.MainStore', {
    ...
    data:{'items':[
        ...
        { 'active': true, 'gridSmallIcon': 'icon-mini-ssl.png', 'gridIcon': 'icon-ssl.png', 'threatTitle': 'SSL Vulnerability', "gridContent":"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam remsdfdsfs aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo."}
    ]},
    proxy: {
        type: 'memory',
        reader: {
